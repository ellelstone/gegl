...
GEGL_CACHED_BABL(format, rgba_float, "RGBA float")
GEGL_CACHED_BABL(format, rgbA_float, "RaGaBaA float")
GEGL_CACHED_BABL(format, rgba_linear_float, "RGBA float")
GEGL_CACHED_BABL(format, rgbA_linear_float, "RaGaBaA float")
GEGL_CACHED_BABL(format, ya_float, "YA float")
GEGL_CACHED_BABL(format, yA_float, "YaA float")
